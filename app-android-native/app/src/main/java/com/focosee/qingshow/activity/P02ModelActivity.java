...
import com.focosee.qingshow.adapter.ModelListAdapter_HasModelHeadRelativeLayout;
...
public class P02ModelActivity extends BaseActivity{
    ...
    private ModelListAdapter_HasModelHeadRelativeLayout followerPeopleListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followedPullRefreshListView.setOnScrollListener(headScrollAdapter);
        followedListView.setOnTouchListener(headScrollAdapter);
...
//                doFollowedRefreshDataTask();
        ...
        followerPeopleListAdapter = new ModelListAdapter_HasModelHeadRelativeLayout(this, followerPeopleList, ImageLoader.getInstance());
