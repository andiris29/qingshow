...
public class AlipayUtil {
    ...
    public static String getOrderInfo(String subject, String body, String price, String id) {
        // 签约合作者身份ID
        String orderInfo = "partner=" + "\"" + PaymentConfig.PARTNER + "\"";

        // 签约卖家支付宝账号
        orderInfo += "&seller_id=" + "\"" + PaymentConfig.SELLER + "\"";
