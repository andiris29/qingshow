 ...
 */
public class ModelListAdapter_HasPersonalHeadRelativeLayout extends BaseAdapter {
    ...
    public ModelListAdapter_HasPersonalHeadRelativeLayout(Context context, ArrayList<MongoPeople> data, ImageLoader imageLoader, int type) {
