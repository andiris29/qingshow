 ...
 */
public class U01RecommFragAdapter extends U01BaseAdapter<MongoShow>{


    public U01RecommFragAdapter(@NonNull List<MongoShow> datas, Context context, int... layoutId) {
