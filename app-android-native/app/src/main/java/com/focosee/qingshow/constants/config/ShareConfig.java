...
public class ShareConfig {
    ...
    public static final String SHARE_SHOW_URL = QSAppWebAPI.HOST_ADDRESS_APPWEB + "?entry=shareShow&_id=";

    public static final String SHARE_TRADE_URL = QSAppWebAPI.HOST_ADDRESS_APPWEB + "?entry=shareTrade";
    //show
    ...
    //bonus
    public static final String SHARE_BONUS_URL = QSAppWebAPI.HOST_ADDRESS_APPWEB + "?entry=shareBonus&initiatorRef=";
