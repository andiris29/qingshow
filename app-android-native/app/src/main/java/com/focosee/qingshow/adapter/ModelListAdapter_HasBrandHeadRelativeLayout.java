 ...
 */
public class ModelListAdapter_HasBrandHeadRelativeLayout extends BaseAdapter {
    ...
    public ModelListAdapter_HasBrandHeadRelativeLayout(Context context, ArrayList<MongoPeople> data, ImageLoader imageLoader) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position == 0){
            ...
            if(null == convertView){
                ...
                headRelativeLayout = (RelativeLayout)convertView.findViewById(R.id.P04_head_relative);
