...
public class P03BrandListAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return (null != data) ? data.size() + 1: 1;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position == 0){
            ...
            if(null == convertView){
                ...
                convertView = layoutInflater.inflate(R.layout.activity_p03_head, null);
                headlayout = (RelativeLayout)convertView.findViewById(R.id.P03_brand_list_tab_control);
                convertView.findViewById(R.id.P03_brand_list_online_button).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((P03BrandListActivity)context).chooseOnlineOroffLine(0);
                    }
                });
                convertView.findViewById(R.id.P03_brand_list_offline_button).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((P03BrandListActivity)context).chooseOnlineOroffLine(1);
                    }
                });
                convertView.setTag(headlayout);
            }
            return convertView;
        }
        ...
        final int final_position = position-1;
        position--;
        if (null == convertView) {
