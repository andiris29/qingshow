package com.focosee.qingshow.tencent.common;
...
public class Configure {
    ...
    private static String appID = "wx75cf44d922f47721";

    //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
    private static String mchID = "1234859302";
    ...
    private static String certPassword = "1234859302";
